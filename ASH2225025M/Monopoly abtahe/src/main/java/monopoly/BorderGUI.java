...
public class BorderGUI extends JPanel {
    private final String squareName;
    private int squareNum;
    private static int total = 0;

    public BorderGUI(int x, int y, int width, int height, String squareName, int rotationDegree) {
    ...
    private void rotation(int degree) {
        ...
        if (degree == 0) {
            ...
            labelName = new JLabel(squareName) {
                protected void paintComponent(Graphics g) {
                    ...
                    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);//Anti-aliasing ensures smooth text rendering.
                    AffineTransform aT = g2.getTransform();//is used to rotate the label's text by the specified degree around its center.
        ...
        // See the fullname of the property,er cost, and er rent
