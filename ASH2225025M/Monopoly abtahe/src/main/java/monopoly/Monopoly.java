...
public class Monopoly implements Serializable {
    public static final String FILENAME = "monopoly.txt";
    ...
    public Monopoly() {
        ...
        gameState.gameBoardGUI = new GameBoardConvertintoGUI(5,5,670,670);
        gameState.decisionState = DecisionState.NONE;
        gameState.gameBoard = new GameBoardCreate();
    ...
    public void printState() {
        ...
        for (Border s: player.properties()){
            System.out.println(">>> " + s.name());
        }
        System.out.println("-----------------------------------------------");
    }

    public ArrayList<Integer> handleSquare(Player player, Border square, int roll) {
    ...
    public void unowned(Player player, Border square) {
    ...
    public void buyProperty(Player player, Border square) {
    ...
    public void owned(Player player, Border square, int roll) {
    ...
    public void payTax(Player player, Taxes tax, Border square) {
        int cost;
